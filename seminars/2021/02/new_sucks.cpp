...
//    }
  ...
  DoubleArray& operator=(const DoubleArray& other) {
    puts("copy");
    // What if this throws?
    auto new_first_ = new T[other.first_size_];
    // What about this?
    auto new_second_ = new T[other.second_size_];
    std::copy(other.first_, other.first_ + other.first_size_, new_first_);
    std::copy(other.second_, other.second_ + other.second_size_, new_second_);
