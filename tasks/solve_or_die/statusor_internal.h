...
template <typename T, typename U>
using IsConstructibleOrConvertibleFromStatusOr = std::disjunction<
...
// `StatusOr<U>`.
template <typename T, typename U>
using IsConstructibleOrConvertibleOrAssignableFromStatusOr = std::disjunction<
    IsConstructibleOrConvertibleFromStatusOr<T, U>, std::is_assignable<T&, StatusOr<U>&>,
...
struct IsDirectInitializationAmbiguous
    : public std::conditional_t<
          std::is_same<std::remove_cv_t<std::remove_reference_t<U>>, U>::value, std::false_type,
...
using IsDirectInitializationValid = std::disjunction<
    ...
    std::negation<std::disjunction<
        std::is_same<absl::StatusOr<T>, std::remove_cv_t<std::remove_reference_t<U>>>,
        std::is_same<absl::Status, std::remove_cv_t<std::remove_reference_t<U>>>,
...
public:
    ...
    template <typename U,
              std::enable_if_t<std::is_constructible<absl::Status, U&&>::value, int> = 0>
