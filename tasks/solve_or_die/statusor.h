...
public:
    ...
    template <typename U,
              std::enable_if_t<
                  std::conjunction<
                      ...
                      std::negation<internal_statusor::IsConstructibleOrConvertibleFromStatusOr<
                          T, U>>>::value,
                  int> = 0>
    ...
    template <
        ...
        std::enable_if_t<
            std::conjunction<std::negation<std::is_same<T, U>>, std::is_constructible<T, const U&>,
                             ...
                             std::negation<internal_statusor::
    ...
    template <
        ...
        std::enable_if_t<
            std::conjunction<
                std::is_convertible<U&&, absl::Status>, std::is_constructible<absl::Status, U&&>,
                std::negation<std::is_same<std::decay_t<U>, absl::StatusOr<T>>>,
