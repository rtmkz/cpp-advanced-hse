...
> Суть: реализовать кодирование с помощью дерева Хаффмана
...
Поищите в документации по ключевым словам IDCT/DCT:
...
> Суть: ускорить свою реализацию, чтобы в релизе она успевала обработать большой jpeg за полминуты
