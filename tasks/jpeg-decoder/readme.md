...
- [JPEG Decoder](#jpeg-decoder)
  ...
  - [Что надо сделать](#что-надо-сделать)
    - [<a id="huffman"></a> Huffman](#-huffman)
    - [<a id="fftw"></a> FFTW](#-fftw)
    - [<a id="baseline"></a> Baseline](#-baseline)
    - [<a id="faster"></a> Faster](#-faster)
    - [<a id="progressive"></a> Progressive](#-progressive)
    - [<a id="fuzz"></a> Fuzz](#-fuzz)
      - [Запуск `fuzz_jpeg` c корпусом](#запуск-fuzz_jpeg-c-корпусом)
  - [Материалы](#материалы)
